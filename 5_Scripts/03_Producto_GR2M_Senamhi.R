...
my_location <- 'D:/Martes_Meteoro/'
setwd(my_location)

# Read netCDF data and load variables and dimensions
#==========================================================
mync   <- nc_open('2_Grillados/netcdf_GR2M/PISCO_HyM_GR2M_v1.1.nc')
print(mync)
...
#Agregue una funcion para guardarlo como archivo csv en ves de text
  ...
  write.csv(qr[,ind],'3_Salida/Caudales_m3_comid.csv', quote = F, row.names = F)
